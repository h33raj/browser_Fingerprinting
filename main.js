...
function rendernewtabpage(name){
	'use strict';
    document.getElementById("maindiv").innerHTML='<h3>Welcome back to the website <b>'+name+'</b>. If I can remember your name even though you are using the <b>Private browsing</b> / <b>Incognito mode</b>, I can surely track you.<br/><br/> This is what big companies are doing. They are spying on you even  when you are using the <b>Private browsing</b> or <b>Incognito mode</b>.<br/><br/><br/><br/><input type="button" class="btn" onclick="forgetme()" value="Forget Me!" /></h3>';
    document.getElementById("user").innerHTML='You are <em>'+name+'!</em>';
}
function rendersubmit(name)
{
	'use strict';
    document.getElementById("maindiv").innerHTML='<h3><b>Thank you! '+name+'</b> Let\'s see the magic... <br/><br/>Now open a <b>Private browsing</b> or <b>Incognito window</b> on your browser and visit the website to see the magic...</h3><br><br><input type="button" class="btn" onclick="forgetme()" value="Forget Me!" /><br><br>';
